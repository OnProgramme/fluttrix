...
const PhoneFrame: FC<OwnProps> = ({
  ...
  const iosBezelWidth = Math.round(baseWidth * 0.047);
  const androidBezelWidth = Math.round(baseWidth * 0.027);
  ...
  if (type === 'ios') {
    return (
      <div style={containerStyle} className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
        ...
        >
          {/* Boutons de volume */}
          <div className="h-[calc(var(--phone-width)*0.107)] w-[calc(var(--bezel-width)*0.21)] bg-gray-800 absolute -left-[calc(var(--bezel-width)*1.21)] top-[calc(var(--phone-width)*0.24)] rounded-l-lg"></div>
          <div className="h-[calc(var(--phone-width)*0.153)] w-[calc(var(--bezel-width)*0.21)] bg-gray-800 absolute -left-[calc(var(--bezel-width)*1.21)] top-[calc(var(--phone-width)*0.413)] rounded-l-lg"></div>
          <div className="h-[calc(var(--phone-width)*0.153)] w-[calc(var(--bezel-width)*0.21)] bg-gray-800 absolute -left-[calc(var(--bezel-width)*1.21)] top-[calc(var(--phone-width)*0.593)] rounded-l-lg"></div>

          {/* Bouton power */}
          <div className="h-[calc(var(--phone-width)*0.213)] w-[calc(var(--bezel-width)*0.21)] bg-gray-800 absolute -right-[calc(var(--bezel-width)*1.21)] top-[calc(var(--phone-width)*0.473)] rounded-r-lg"></div>

          <div className="rounded-[2rem] overflow-hidden w-full h-full bg-white">
            {/* Encoche */}
            <div className="absolute top-0 inset-x-0">
              <div className="relative mx-auto bg-gray-800 h-[calc(var(--phone-width)*0.083)] w-[calc(var(--phone-width)*0.5)] rounded-b-[1.5rem]"></div>
            </div>
      ...
      >
        ...
        <div className="absolute top-[calc(var(--phone-width)*0.02)] left-1/2 transform -translate-x-1/2">
          <div className="relative">
            <div className="h-[calc(var(--phone-width)*0.025)] w-[calc(var(--phone-width)*0.025)] bg-black rounded-full">
